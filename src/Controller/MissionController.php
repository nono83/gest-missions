...
class MissionController extends AbstractController
{
    ...
    /**
     * @Route("/list_datatables", name="app_mission_list_datatables")
     */
    ...
    /**
     * @Route("/edit/{id}",requirements={"id"="\d+"}, methods={"GET", "POST"}, name="app_mission_edit")
     */
    public function edit(Request $request, int $id, MissionRepository $missionRepository): Response
    {
        //A mettre en commentaire si appel au paramconverter config/packages/sensio_framework_extra.yaml
        $mission = $missionRepository->findOneBy(['id' => $id]);
        if (!$mission) {
